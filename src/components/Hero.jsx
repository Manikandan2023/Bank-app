    ...
    <section id='home' className={` flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row justify-between items-center w-full'>
          <h1 className='flex-1 flex-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]'>The Next <br className='sm:block-hidden'/> {""} 
     ...
     <div className={` flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative `}>
      <img src={robot} alt="billig" className='h-[100%] w-[100%] relative z-[5px]' />
